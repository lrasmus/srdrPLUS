...
ActiveRecord::Schema.define(version: 2019_04_04_102455) do
  ...
  create_table "assignment_option_types", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "assignment_options", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "label_type_id"
    t.integer "assignment_id"
    t.integer "assignment_option_type_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["assignment_id"], name: "index_assignment_options_on_assignment_id"
    t.index ["assignment_option_type_id"], name: "index_assignment_options_on_assignment_option_type_id"
    t.index ["label_type_id"], name: "index_assignment_options_on_label_type_id"
  end
  ...
  create_table "key_questions", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin", force: :cascade do |t|
    ...
    t.index ["name"], name: "index_key_questions_on_name", unique: true
  end
